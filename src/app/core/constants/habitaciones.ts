...
export abstract class Habitaciones {
    ...
    static readonly ITEMS: Habitacion[] = [
        ...
        { numero: '301', capacidadMaxima: 1, aire: false, balcon: false, cama1m: 1, precios: Precios.PRECIO301 },
        ...
        { numero: '702', capacidadMaxima: 5, aire: false, balcon: false, cama1m: 3, cama140m: 1, precios: Precios.PRECIO702 },
